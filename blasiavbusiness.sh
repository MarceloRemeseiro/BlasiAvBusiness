...
# Nombres fijos
REPOSITORIO="blasiavbusiness"
CONTAINER_NAME=blasiavbusiness # Nombre del contenedor
IMAGE_NAME=blasiavbusiness # Nombre de la imagen
PORT=1005:8080  # Puerto de la aplicación
